...
import { useScreenEffect } from "@/views/favorite-events/context/use-screen-effect";
import { useFavoriteEventsScreenView } from "@/views/favorite-events/context/use-favorite-events-screen-view";
import { useOperation } from "@/views/favorite-events/context/use-operation";

export default function FavoriteEventsScreenView() {
  useScreenEffect();

  const { events, isLoading, nextToken } = useFavoriteEventsScreenView();
  ...
  return (
    <View style={styles.container}>
      <SafeAreaView edges={["top"]} style={styles.navigationBar}>
        <Text style={styles.headerText}>찜한 프로그램</Text>
      </SafeAreaView>
